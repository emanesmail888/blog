...
$posts = $db->select($query);
 ...
 if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    user_id='$user_id',status = '$status',slug='$slug',tags='$tags',image='$folder', updated_at = now() ,added_by='ADM' WHERE id = '$id'";
      ...
      <div class="row">
        ...
        <div class="col-md-8 offset-2">
          <div class="tile">
            ...
            <?php 
              ...
              <form class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="mb-3 row">
                  ...
                  <div class="col-md-9">
                    <input class="form-control col-md-9" type="text" name="title" value="<?php echo $result['title'] ?>" placeholder="Enter post title" required>
                  </div>
                </div>
            ...
            <input type="text" id="tag-input1" class="form-control col-md-9" name="tags" value="<?php echo  $result['tags'] ;?>"
              data-role="tagsinput"  >
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-9">
                  <textarea name="details" id="details" class="form-control col-md-9 ckeditor" cols="30" placeholder="Enter Post Details " rows="10">
